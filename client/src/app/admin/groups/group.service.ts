...
export class GroupService {
     ...
     * Add users to given group.
     */
    public addCategories(groupId: number, categoryIds: number[]) {
        return this.httpClient.post('groups/'+groupId+'/add-users', {ids: categoryIds});
    }

    /**
     * Remove users from given group.
     */
    public removCategories(groupId: number, categoryIds: number[]) {
        return this.httpClient.post('groups/'+groupId+'/remove-users', {ids: categoryIds});
    }
}