...
@section('content')
    <div style="line-height: 18px; font-family: 'Century Gothic',Verdana,Arial,sans-serif; font-size: 13px; color:#2b2e2f;">
        <p>Hi there,</p>

        <p>This is an automated response to let you know that we’ve received your request. You can view it <a href="{{url('help-center/tickets/'.$ticket->id)}}">AP{{$ticket->id}}</a></p>
